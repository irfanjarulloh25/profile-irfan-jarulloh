...
<template>
  <BackgroundStars />
  <div id="header"
    class="relative flex flex-col md:flex-row items-center bg-transparent text-white border-2 border-blue-600 shadow-[0_0_10px_#2c75ff,0_0_22px_#2c75ff] rounded-xl w-11/12 md:w-3/5 h-auto md:h-[25rem] mx-auto mt-[7rem] md:mt-[12rem] p-6 mb-[10rem] md:-translate-x-11 scroll-mt-30"
  >
    <!-- Image -->
    <div
      class="flex justify-center md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 md:translate-x-1/2 z-10 mb-6 md:mb-0"
    >
      <img
        :src="profile"
        alt="Profile"
    ...
    <div class="text-center md:text-left md:ml-[40px] md:mr-[150px] text-white">
      <h2 class="text-2xl sm:text-3xl md:text-4xl italic font-semibold mb-5">
        Hi, saya
        <span class="text-blue-600 font-extrabold">Irfan Jarulloh</span>
      </h2>
      <div
        class="name text-2xl md:text-4xl border-b-5 border-blue-600 mb-4 inline-block"
      >
        Fullstack Developer
      </div>
      ...
      <div class="flex justify-center md:justify-start gap-8 mt-5">
        <a
